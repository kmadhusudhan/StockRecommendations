...
class AppUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_user" do
    assert_difference('AppUser.count') do
      post app_users_url, params: { app_user: { dob: @app_user.dob, email: @app_user.email, name: @app_user.name } }
    end
  ...
  test "should update app_user" do
    patch app_user_url(@app_user), params: { app_user: { dob: @app_user.dob, email: @app_user.email, name: @app_user.name } }
